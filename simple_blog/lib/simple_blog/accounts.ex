defmodule SimpleBlog.Accounts do
  ...
  alias SimpleBlog.Accounts.{User, UserToken, UserNotifier}
  ...
  See `SimpleBlog.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `SimpleBlog.Accounts.User.password_changeset/3` for a list of supported options.
